...
.. image:: /_static/launcher_home.png
   :alt: The TheGates launcher home screen, showing the search bar
         and featured gates: Welcome, Starcatcher, Earth, Luckshot,
         and Survive the Slimes.
   :class: home-pic-left

| *The launcher's home screen, with search, featured gates, and a
  URL bar that takes any* ``.gate`` *address.*
...
| - **Every gate runs in its own OS-level sandbox**, so a hostile
    ...
    gates. See :doc:`/security/overview`.
...
| **Want to build with it?** → :doc:`/getting-started/quickstart`.
